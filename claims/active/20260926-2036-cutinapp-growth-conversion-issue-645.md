...
branch: feat/issue-645-flyer-rich-description
status: working
started_at: 2026-09-26T20:36:00Z
depends_on: none
files_or_scope:
- frontend: GlobalAiDescriptionEnhancer, AiContentService, FormattedText, editores/páginas públicas
- API: AiContentController, AiDescriptionService, contexto de evento/produção e testes
